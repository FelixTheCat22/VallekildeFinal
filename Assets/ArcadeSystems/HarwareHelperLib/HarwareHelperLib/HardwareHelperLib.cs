...
namespace HardwareHelperLib
{
    ...
    public class HH_Lib
    {
        ...
        public bool ResetDevice(IntPtr hDevInfo, IntPtr devInfoData)
        {
            ...
            pcp.StateChange = ((0x00000003));// Native.DICS_PROPCHANGE; // for reset
        ...
        private bool ChangeIt(IntPtr hDevInfo, Native.SP_DEVINFO_DATA devInfoData, bool bEnable)
        {
            try
            {
                ...
                {
                    pcp.ClassInstallHeader.cbSize = Marshal.SizeOf(typeof(Native.SP_CLASSINSTALL_HEADER));
                    pcp.ClassInstallHeader.InstallFunction = Native.DIF_DETECT;
                    ...
                    if (Native.SetupDiSetClassInstallParams(hDevInfo, ptrToDevInfoData, ptrToPcp, Marshal.SizeOf(typeof(Native.SP_PROPCHANGE_PARAMS))))
                    {
                        ...
                        Native.SetupDiCallClassInstaller(Native.DIF_PROPERTYCHANGE, hDevInfo, ptrToDevInfoData);//Native.DIF_PROPERTYCHANGE
                    }
                    //pcp.ClassInstallHeader.cbSize = Marshal.SizeOf(typeof(Native.SP_CLASSINSTALL_HEADER));
                    //pcp.ClassInstallHeader.InstallFunction = Native.DIF_PROPERTYCHANGE;
                    //pcp.StateChange = Native.DICS_ENABLE;
                    //pcp.Scope = Native.DICS_FLAG_GLOBAL; //Native.DICS_FLAG_CONFIGSPECIFIC;
                    //pcp.HwProfile = 0;
                }
                else
                {
                ...
                ptrToPcp = Marshal.AllocHGlobal(szOfPcp);
                Debug.Log("I was here! 5");
                Marshal.StructureToPtr(pcp, ptrToPcp, true);
                Debug.Log("I was here! 6");
                szDevInfoData = Marshal.SizeOf(devInfoData);
                Debug.Log("I was here! 7");
                ptrToDevInfoData = Marshal.AllocHGlobal(szDevInfoData);
                Debug.Log("I was here! 8");
                Marshal.StructureToPtr(devInfoData, ptrToDevInfoData, true);
                Debug.Log("I was here! 9");
                //bool rslt1 = Native.SetupDiSetClassInstallParams(hDevInfo, ptrToDevInfoData, ptrToPcp, Marshal.SizeOf(typeof(Native.SP_PROPCHANGE_PARAMS)));
                Debug.Log("I was here! 10");
                bool rstl2 = Native.SetupDiCallClassInstaller(Native.DIF_DETECT, hDevInfo, ptrToDevInfoData);
                Debug.Log("I was here! 11");
                if ((!rstl2)) //if ((!rslt1) || (!rstl2))
                {
                    Debug.Log("I was here! 12");
